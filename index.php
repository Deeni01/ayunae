...
<?php include_once('includes/header.php');?>
        ...
        <header class="py-1 bg-brown">
            <div class="container px-5 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder" style="font-size:70px; padding-top: 0.5em; text-align:center;">Ayunae.co</h1>
                    <h5>Welcome to Ayunae <span class="w3-tag">Let's shop with us!</span></h5>
            ...
            <header class="w3-display-container w3-wide" id="home">
                <img class="w3-image" src="/ayunae/assets/home.png" alt="Fashion Blog" width="1600" height="1060">
                <div class="w3-display-left w3-padding-large">
                        <h1 class="w3-text-white">We offers</h1>
                        <h1 class="w3-jumbo w3-text-white w3-hide-small"><b>MODEST ATTIRE</b></h1>
                        <h6><button class="w3-button w3-white w3-padding-large w3-large w3-opacity w3-hover-opacity-off" onClick="location.href='shop-categories.php'"
